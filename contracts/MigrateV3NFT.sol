...
import {IUNCX_ProofOfReservesV2_UniV3} from "./v2/IUNCX_ProofOfReservesV2_UniV3.sol";
...
contract MigrateV3NFT is IMigrateV3NFT, IERC721Receiver, ReentrancyGuard {
    IUNCX_ProofOfReservesV2_UniV3 public OLD_ProofOfReservesUniV3;
    IUNCX_LiquidityLocker_UniV3 public NEW_ProofOfReservesUniV3;

    constructor(IUNCX_ProofOfReservesV2_UniV3 _Old_ProofOfReservesUniV3, IUNCX_LiquidityLocker_UniV3 _New_ProofOfReservesUniV3) {
    ...
    function migrate (uint256 _lockId, INonfungiblePositionManager _nftPositionManager, uint256 _tokenId) external override nonReentrant returns (bool) {
        ...
        IUNCX_ProofOfReservesV2_UniV3.Lock memory v1lock = OLD_ProofOfReservesUniV3.getLock(_lockId);
        IUNCX_LiquidityLocker_UniV3.LockParams memory v2LockParams;
