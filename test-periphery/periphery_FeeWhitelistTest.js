...
describe("Uniswap V3 Lockers", function () {
  ...
  async function deployFixture() {
      ...
      return { owner, bob, dustReceiver, additionalCollector, weth, uncx, tokenA, tokenB, univ3locker, fullRangeConvertor, feeResolver, pool, nftId_unlocked, NftPositionManager };
  }
  ...
  describe("Flat Fee Whitelist Testing", function () {
      ...
      it("Should allow a lock to go through without paying the flat fee", async function () {
          const { univ3locker, fullRangeConvertor, feeResolver, owner, bob, additionalCollector, dustReceiver, nftId_unlocked, NftPositionManager } = await loadFixture(deployFixture);
          ...
          await feeResolver.whitelistFeeAccount(fullRangeConvertor.target, true)
