...
describe("Uniswap V3 Lockers", function () {
    ...
    async function deployFixture() {
        ...
        return { owner, bob, dustReceiver, additionalCollector, weth, uncx, tokenA, tokenB, univ3locker, fullRangeConvertor, pool, nftId_unlocked_1, nftId_unlocked_2, nftId_unlocked_3, NftPositionManager, autoCollector, lpFeeReceiver, collectFeeReceiver };
    }
